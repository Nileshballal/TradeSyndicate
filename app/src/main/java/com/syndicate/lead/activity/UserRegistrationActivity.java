...
public class UserRegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_lay);
        ...
        if (utility.isNet(UserRegistrationActivity.this)){
    ...
    private void verifyemail()  {
        progressDialog_1 = new ProgressDialog(UserRegistrationActivity.this);
        ...
        button_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edt_otp.getText().toString().length()!=6){
                    Toast.makeText(UserRegistrationActivity.this,"Please enter OTP",Toast.LENGTH_SHORT).show();
                }else {
        ...
        protected void onPostExecute(String integer) {
            ...
            if (!integer.equalsIgnoreCase("")) {
                ...
                try {
                    ...
                    ArrayAdapter<State> dataAdapter = new ArrayAdapter<State>(UserRegistrationActivity.this, android.R.layout.simple_spinner_item, stateArrayList);
                ...
                if (utility.isNet(UserRegistrationActivity.this)) {
                    ...
                    Toast.makeText(UserRegistrationActivity.this, "Record not found", Toast.LENGTH_SHORT).show();
                }
            }
        }
        ...
        protected void onPostExecute(String integer) {
            ...
            if (!integer.equalsIgnoreCase("")) {
                ...
                try {
                    ...
                    ArrayAdapter<State> dataAdapter = new ArrayAdapter<State>(UserRegistrationActivity.this, android.R.layout.simple_spinner_item, cityArrayList);
                    dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        ...
        protected void onPostExecute(String integer) {
            ...
            if (!integer.equalsIgnoreCase("")) {
                ...
                try {
                    ...
                    ArrayAdapter<State> dataAdapter = new ArrayAdapter<State>(UserRegistrationActivity.this, android.R.layout.simple_spinner_item, districtArrayList);
                    dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    private class UploadFileToServer extends AsyncTask<Void, Integer, String> {
        ...
        private String uploadFile() {
            ...
            try {
                ...
                multipartEntity.addPart("role",new StringBody("4"));
                ...
                multipartEntity.addPart("total_experience",new StringBody(Experience));
                multipartEntity.addPart("experience_in",new StringBody("Everything"));
            ...
            try {
                if (result.contains("token_type")) {
                    ...
                    Toast.makeText(UserRegistrationActivity.this, "User registered successfully", Toast.LENGTH_SHORT).show();
                     startActivity(new Intent(UserRegistrationActivity.this,LeadsMainActivity.class)
                     .setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                     finish();
                }else {
                    JSONObject jsonObject=new JSONObject(result);
                    JSONArray ja = jsonObject.getJSONArray("original");
                    Toast.makeText(UserRegistrationActivity.this,ja.toString(),Toast.LENGTH_LONG).show();
                }

            } catch (Exception e) {
                Toast.makeText(UserRegistrationActivity.this, e.toString(), Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        }

...
public class CorporateEnquiriesLeadAdapter extends RecyclerView.Adapter<CorporateEnquiriesLeadAdapter.ViewHolder> {
    ...
    public CorporateEnquiriesLeadAdapter(Context context, ArrayList<Bidding>leadsList) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        viewHolder=holder;
         ...
         String d = namesList [0];
            ...
            String Status=leadsList.get(position).getStatus();
        ...
        if (Status.equals("0")){
            ...
            holder.txt_reject.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ((EnquriesActivity) context).setstatus
                            (leadsList.get(position).getId(),"0");
        ...
        holder.txt_accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((EnquriesActivity) context).setstatus
                        (leadsList.get(position).getId(),"1");
